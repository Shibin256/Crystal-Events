        ...
        <div class="blank">
            <div class="blank-page">
                <table id="table" class="">
                    ...
                    <tbody>
                        <?php
                        $sql = "select * from users,login where users.email=login.email order by status";
                        $res = sel($sql);

                        while ($row = mysqli_fetch_assoc($res)) {
                        ?>
                        <tr>
                            <td><span class="bt-content"><?php echo $row['firstname']; ?></span></td>
                            <td><span class="bt-content"><?php echo $row['lastname']; ?></span></td>
                            <td><span class="bt-content"><?php echo $row['phone']; ?></span></td>
                            <td><span class="bt-content"><?php echo $row['email']; ?></span></td>
                            <td><span class="bt-content"><?php echo $row['housename']; ?></span></td>
                            ...
                            <td>
                                ...
                                <div class="btn-group">
                                    <button class="btn btn-sm btn-success"
                                        onclick="accept_or_reject('<?php echo $row['email']; ?>',1)">Accept</button>
                                    <button class="btn btn-sm btn-danger"
                                        onclick="accept_or_reject('<?php echo $row['email']; ?>',0)">Reject</button>
                                </div>
                                <?php
                                    } else {
                                        echo "-";
...
$(document).ready(function() {
    let table = new DataTable('#table', {
        ...
        buttons: [{
            ...
            extend: 'excelHtml5',
            title: "Users(<?php echo $email; ?>) - Crystal Events",
