                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td><a href="javascript:;" data-toggle="modal" data-target="#exampleModal" onclick="{document.getElementById('name').innerHTML='<?php echo $row['event_name']; ?>';document.getElementById('category').innerHTML='<?php echo $row['cat_title']; ?>';document.getElementById('requirements').innerHTML='<?php echo $row['requirements']; ?>'}"><?php echo $row['event_name']; ?></a>
                                ...
                                <td>
                                    <div class="btn-group">
                                        ...
                                        if ($row['pay_id1'] == 0) {
                                        ?>
                                            <button class="btn btn-sm btn-primary" data-toggle="modal" data-target="#exampleModal1" onclick="pay('<?php echo $row['book_id']; ?>',<?php echo round($row['price'] * 0.40); ?>)">Pay
                                                Advance Now</button>
                                        ...
                                        ?>
                                            <button class="btn btn-sm btn-info" data-toggle="modal" data-target="#exampleModal1" onclick="pay2('<?php echo $row['book_id']; ?>',<?php echo $row['price'] - round($row['price'] * 0.40); ?>)">Pay
                                                Balance Now</button>
                                        <?php
                                        }
                                        ?>
