                            ...
                            <div class="col-lg-12">
                                ...
                                <div class="invoice-details mt25">
                                    <div class="well">
                                        <ul class="list-unstyled mb0">
                                            <?php
                                            $sql = "select * from test_book,payment where book_id=$id";
                                            $res = sel($sql);
                                ...
                                <div class="invoice-to mt25">
                                    <ul class="list-unstyled">
                                        <?php
                                        $sql = "select * from customer,test_book where customer.email_id=test_book.email_id and test_book.book_id=$id";
                                        $res = sel($sql);
                                        $row = mysqli_fetch_assoc($res);
                                ...
                                <div class="invoice-items">
                                    <div class="table-responsive" style="overflow: hidden; outline: none;" tabindex="0">
                                        <table class="table table-bordered">
                                            ...
                                            <tbody>
                                                <?php
                                                $sql = "select * from test_book,bike where test_book.bike_id=bike.bike_id and book_id=$id";
                                                $res = sel($sql);
                                                $row = mysqli_fetch_assoc($res);
                                                ?>
                                                <tr>
