    ...
    <nav class="main-menu">
        <ul>
            ...
            <li class="has-subnav">
                ...
                <ul>
                    <li>
                        <a class="subnav-text" href="addbikes.php">
                            Add Bikes
                        </a>
                    </li>
                    <li>
                        <a class="subnav-text" href="viewbikes.php">
                            View Bikes
                        </a>
                    </li>
                </ul>
            ...
            <li class="has-subnav">
                <a href="javascript:;">
                <i class="fa fa-check-square-o nav_icon"></i>  <span class="nav-text">
                        Bookings
                    </span>
                    <i class="icon-angle-right"></i><i class="icon-angle-down"></i>
                </a>
                <ul>
                    <li>
                        <a class="subnav-text" href="order.php">
                            Bike
                        </a>
                    </li>
                    <li>
                        <a class="subnav-text" href="test_book.php">
                            Test Drive
                        </a>
                    </li>
                </ul>
    ...
    <section class="wrapper scrollable" style="opacity: 1;">
        ...
        <section class="title-bar">
            <div class="logo" style="width: 17%;">
                <h1><a href="index.html"><img src="images/.png" alt="" />Autodoc</a></h1>
            </div>
