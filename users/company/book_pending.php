        ...
        <div class="blank">
            <div class="blank-page">
                <table id="table">
                    ...
                    <tbody>
                        <?php
                        $sql = "select * from bookings,events,users where users.email=bookings.user_email and events.event_id=bookings.event_id and company_email='$email' and book_status=0 order by book_status,event_date";
                        $res = sel($sql);
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <button class="btn btn-sm btn-primary"
                                    onclick="update(<?php echo $row['order_id']; ?>,<?php echo $row['status'] + 1; ?>,'<?php echo $row['email']; ?>')">Update
